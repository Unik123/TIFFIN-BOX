...
<head>
    ...
    <title>Shop Profile | Tiffin Box</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container px-5 pt-4" id="profile-body">
        <div class="row my-4 pb-2 border-bottom">
            ...
            <h2 class="pt-3 display-6"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-shop" viewBox="0 0 16 16">
