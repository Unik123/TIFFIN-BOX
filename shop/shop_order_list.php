...
<head>
    ...
    <title>Customer Order List | Tiffin Box</title>
</head>
    ...
    <div class="container px-5 pt-4" id="shop-body">
        ...
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active px-4" id="acpt-tab" data-bs-toggle="tab" data-bs-target="#nav-acpt" type="button" role="tab" aria-controls="nav-acpt" aria-selected="true">ACPT | Accepted</button>
                <button class="nav-link px-4" id="prep-tab" data-bs-toggle="tab" data-bs-target="#nav-prep" type="button" role="tab" aria-controls="nav-prep" aria-selected="true">PREP | Preparing</button>
                <button class="nav-link px-4" id="rdpk-tab" data-bs-toggle="tab" data-bs-target="#nav-rdpk" type="button" role="tab" aria-controls="nav-rdpk" aria-selected="true">RDPK | Wait for pick-up</button>
                <button class="nav-link px-4" id="fnsh-tab" data-bs-toggle="tab" data-bs-target="#nav-fnsh" type="button" role="tab" aria-controls="nav-fnsh" aria-selected="false">FNSH | Finished</button>
            </div>
        </nav>
                ...
                ?>
                    <div class="row row-cols-1 row-cols-md-3">
                        ...
                        <?php while ($og_row = $acpt_result->fetch_array()) { ?>
                            <div class="col">
                                <a href="shop_order_detail.php?orh_id=<?php echo $og_row["orh_id"] ?>" class="text-dark text-decoration-none">
                                    <div class="card mb-3">
                                                    ...
                                                    <div class="col">Name:
                                                        ...
                                                        switch ($cust_arr["c_type"]) {
                                                            ...
                                                            case "INS":
                                                                ...
                                                                break;
                                                            case "TAS":
                                                                $cust_type = "Teaching Assistant";
                                                                break;
                                                            case "STF":
                                                                $cust_type = "Faculty Staff";
                                                                break;
                                                            case "GUE":
                                                                $cust_type = "Visitor";
                                                                break;
                                            ...
                                            <div class="card-text row row-cols-1">
                                                <small>
                                                    ...
                                                    <div class="col">Name:
                                                        ...
                                                        switch ($cust_arr["c_type"]) {
                                                            case "STD":
                                                                $cust_type = "Below 15 years";
                                                                break;
                                                            case "INS":
                                                                $cust_type = "16 years - 20 years";
                                                                break;
                                                            case "TAS":
                                                                $cust_type = "21 years - 30 years";
                                                                break;
                                                            case "STF":
                                                                $cust_type = "31 years - 40 years";
                                                                break;
                                                            case "GUE":
                                                                $cust_type = "41 years - 50 years";
                                                                break;
                                                            default:
                                                                $cust_type = "Above 51 years";
                                                        }
                                                        echo "{$cust_arr['c_firstname']} {$cust_arr['c_lastname']} ({$cust_type})";
                                                        ?>
                                                    </div>
