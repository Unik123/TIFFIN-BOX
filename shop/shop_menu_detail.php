...
<head>
    ...
    <title>Menu Detail | Tiffin Box</title>
</head>
                    ...
                    <div class="card border-secondary">
                        <div class="card-body">
                            <h5 class="card-title"><?php
                                                    ...
                                                    $count_result = $mysqli->query($count_query)->fetch_array();
                                                    if (is_null($count_result["prf"])) {
                                                        echo "0.00";
                                                    } else {
                                                        echo $count_result["prf"];
                                                    }
                                                    ?> Rs.</h5>
            ...
            <form class="form-floating mb-3" method="GET" action="shop_menu_detail.php">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-auto">
                        ...
                        <button type="reset" class="btn btn-danger" onclick="javascript: window.location='shop_menu_detail.php?f_id=<?php echo $f_id ?>'">Clear</button>
                    </div>
                </div>
            </form>
        </div>
