...
<head>
    ...
    <title>Shop Owner Home | Tiffin Box</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container p-5" id="shop-dashboard">
        <h2 class="border-bottom pb-2"><i class="bi bi-graph-up"></i> Shop Dashboard <span class="small fw-light"><?php echo date('F j, Y'); ?></span></h2>
