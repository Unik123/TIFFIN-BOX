...
<head>
    ...
    <title>Shop Menu List | Tiffin Box</title>
</head>
            ...
            <form class="form-floating mb-3" method="GET" action="shop_menu_list.php">
                <div class="row g-2">
                    ...
                    <div class="col-auto">
                        ...
                        <button type="reset" class="btn btn-danger" onclick="javascript: window.location='shop_menu_list.php'">Clear</button>
            ...
            <?php } else { ?>
                <div class="table-responsive">
                    <table class="table rounded-5 table-light table-striped table-hover align-middle caption-top mb-5">
                        <caption><?php echo $search_numrow; ?> menu(s) <?php if (isset($_GET["search"])) { ?><br /><a href="shop_menu_list.php" class="text-decoration-none text-danger">Clear Search
                            ...
                            while ($row = $search_result->fetch_array()) { ?>
                                <tr>
                                    ...
                                    <td><img <?php
                                                ...
                                                ?> style="width:75%; height:125px; object-fit:cover;" class="img-fluid rounded" alt="<?php echo $food_row["f_name"] ?>">
                                    </td>
                                    ...
                                    <td>
                                        <a href="shop_menu_detail.php?f_id=<?php echo $row["f_id"] ?>" class="btn btn-sm btn-primary">View</a>
                                        <a href="shop_menu_edit.php?f_id=<?php echo $row["f_id"] ?>" class="btn btn-sm btn-outline-success">Edit</a>
                                        <a href="shop_menu_delete.php?f_id=<?php echo $row["f_id"] ?>" class="btn btn-sm btn-outline-danger">Delete</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
