...
<head>
    ...
    <title>Restricted Access | Tiffin Box</title>
</head>
...
<body class="d-flex flex-column h-100">
    <header class="navbar navbar-expand-md navbar-light fixed-top bg-light shadow-sm mb-auto">
        <div class="container-fluid mx-4">
            <a href="index.php">
                <img src="https://cdn.dribbble.com/users/1172898/screenshots/5874290/tiffin_box.jpg" width="75" class="me-2" alt="Sai Logo">
            </a>
