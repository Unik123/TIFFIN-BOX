        ...
        <div class="mt-4 border-bottom">
            ...
            <form class="form-floating mb-3" method="GET" action="admin_shop_list.php">
                <div class="row g-2">
                    ...
                    <div class="col">
                        <input type="text" class="form-control" id="shopname" name="sn" placeholder="Shop Name" <?php if (isset($_GET["search"])) { ?>value="<?php echo $_GET["sn"]; ?>" <?php } ?>>
                    </div>
                    <div class="col-auto">
                        <button type="submit" name="search" value="1" class="btn btn-success">Search</button>
                        <button type="reset" class="btn btn-danger" onclick="javascript: window.location='admin_shop_list.php'">Clear</button>
        ...
        <?php } else { ?>
            <div class="table-responsive">
                <table class="table rounded-5 table-light table-striped table-hover align-middle caption-top mb-5">
                    <caption><?php echo $search_numrow; ?> shop(s) <?php if (isset($_GET["search"])) { ?><br /><a href="admin_shop_list.php" class="text-decoration-none text-danger">Clear Search
                    ...
                    <tbody>
                        ...
                        while ($row = $search_result->fetch_array()) { ?>
                            <tr>
                                ...
                                <td class="small"><?php echo $row["s_email"]; ?><br /><?php echo "(01) " . $row["s_phoneno"]; ?></td>
                                <td>
