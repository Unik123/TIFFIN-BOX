...
<body class="d-flex flex-column h-100">
    ...
    <div class="container px-5 py-4" id="cart-body">
        <div class="row my-4 pb-2 border-bottom">
            ...
            <h2 class="pt-3 display-6"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
        ...
        <div class="row row-cols-1 mt-4">
            <dl class="row">
                ...
                <dd class="col-sm-9"><?php
                                        if ($row["c_gender"] == "M") {
                                            echo "Male";
                                        } else if ($row["c_gender"] == "F") {
                                            echo "Female";
                                        } else if ($row["c_gender"] == "N") {
                                            echo "Non-binary";
                                        } ?>
                </dd>
                ...
                <dd class="col-sm-9"><?php
                                        if ($row["c_type"] == "STD") {
                                            echo "Student";
                                        } else if ($row["c_type"] == "INS") {
                                            echo "Instructor";
                                        } else if ($row["c_type"] == "TAS") {
                                            echo "Teaching Assistant";
                                        } else if ($row["c_type"] == "STF") {
                                            echo "Faculty Staff";
                                        } else if ($row["c_type"] == "GUE") {
                                            echo "Guest";
                                        } else if ($row["c_type"] == "ADM") {
                                            echo "Admin";
                                        } else {
                                            echo "Others";
                                        }
