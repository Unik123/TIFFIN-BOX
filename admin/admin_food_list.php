...
<body class="d-flex flex-column h-100">
    ...
    <div class="container p-2 pb-0" id="admin-dashboard">
        <div class="mt-4 border-bottom">
            ...
            <form class="form-floating mb-3" method="GET" action="admin_food_list.php">
                <div class="row g-2">
                    <div class="col">
                        <input type="text" class="form-control" id="f_name" name="f_name" placeholder="Food name" <?php if (isset($_GET["search"])) { ?>value="<?php echo $_GET["f_name"]; ?>" <?php } ?>>
                    </div>
                    <div class="col">
                    ...
                    <div class="col-auto">
                        ...
                        <button type="reset" class="btn btn-danger" onclick="javascript: window.location='admin_food_list.php'">Clear</button>
    ...
    <div class="container pt-2" id="cust-table">
        ...
        if (!isset($_GET["search"])) {
            ...
            if ($search_sid != "") {
                $sid_clause = " AND f.s_id = {$search_sid} ";
            } else {
                $sid_clause = " ";
            }
        ...
        <?php } else { ?>
            <div class="table-responsive">
                <table class="table rounded-5 table-light table-striped table-hover align-middle caption-top mb-5">
                    <caption><?php echo $search_numrow; ?> menu(s) <?php if (isset($_GET["search"])) { ?><br /><a href="admin_food_list.php" class="text-decoration-none text-danger">Clear Search
                        ...
                        while ($row = $search_result->fetch_array()) { ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="admin_food_edit.php?s_id=<?php echo $row["s_id"]; ?>&f_id=<?php echo $row["f_id"] ?>" class="btn btn-sm btn-outline-success">Edit</a>
