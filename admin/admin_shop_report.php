                    ...
                    <div class="card border-secondary">
                        <div class="card-body">
                            <h5 class="card-title">
                                ...
                                if (is_null($result["rev"])) {
                                    $grandtotal = 0;
                                } else {
                                    $grandtotal = $result["rev"];
                                }
                        ...
                        <div class="card-body">
                            <h5 class="card-title">
                                ...
                                $query = "SELECT COUNT(*) AS cnt FROM order_header orh
                                    WHERE orh.s_id = {$s_id} AND orh_orderstatus = 'FNSH' AND (DATE(orh_finishedtime) BETWEEN DATE('{$start_date}') AND DATE('{$end_date}'));";
                                $result = $mysqli->query($query)->fetch_array();
                                if (is_null($result["cnt"])) {
                                    $num_order = 0;
                                } else {
                                    $num_order = $result["cnt"];
                                }
                        ...
                        <div class="card-body">
                            <h5 class="card-title">
                                ...
                                if ($num_order == 0) {
                                    ...
                                    printf("%.2f Rs.", $grandtotal / $num_order);
                                }
                                ?>
                            </h5>
                        ...
                        <div class="card-body">
                            <h5 class="card-title">
                                ...
                                $query = "SELECT SUM(ord.ord_amount) AS amt FROM order_header orh INNER JOIN order_detail ord ON orh.orh_id = ord.orh_id
                                    WHERE orh.s_id = {$s_id} AND orh_orderstatus = 'FNSH' AND (DATE(orh_finishedtime) BETWEEN DATE('{$start_date}') AND DATE('{$end_date}'));";
                                $result = $mysqli->query($query)->fetch_array();
                                if (is_null($result["amt"])) {
                                    echo "0 plates";
                                } else {
                                    echo $result["amt"] . " plates";
                                }
                                ?>
                            </h5>
                        ...
                        <div class="card-body">
                            <h5 class="card-title">
                                ...
                                if ($num_rows == 0) {
                                    ...
                                    echo "{$result['odh']}:00 - {$result['odh']}:59";
                                }
                                ?>
                            </h5>
