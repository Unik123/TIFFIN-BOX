...
<body class="d-flex flex-column h-100">
    ...
    <div class="container px-5 py-4" id="shop-body">
                ...
                <div class="row g-2">
                    ...
                    <div class="col">
                        <select class="form-select" id="utype" name="ut">
                            ...
                            <?php } else { ?>
                                <option selected value="">Customer Age</option>
                                <option value="STD">Below 15 Years</option>
                                <option value="INS">16 Years - 20 Years</option>
                                <option value="TAS">21 Years - 30 Years</option>
                                <option value="STF">31 Years - 40 Years</option>
                                <option value="GUE">41 Years - 50 Years</option>
                                <option value="ADM">Admin</option>
                                <option value="OTH">Above 10 Years</option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="col">
                    ...
                    <div class="col-auto">
                        ...
                        <button type="reset" class="btn btn-danger" onclick="javascript: window.location='admin_food_detail.php?f_id=<?php echo $f_id ?>'">Clear</button>
                    </div>
                </div>
            </form>
        </div>
        ...
        if (isset($_GET["search"])) {
            if ($_GET["c_id"] != '') {
                $cid_clause = " AND orh.c_id = '{$_GET['c_id']}';";
            } else {
                $cid_clause = ";";
            }
            ...
            <div class="container align-items-stretch">
                ...
                <div class="table-responsive">
                    <table class="table rounded-5 table-light table-striped table-hover align-middle caption-top mb-3">
                        <caption><?php echo $numrow; ?> order(s) <?php if (isset($_GET["search"])) { ?><br /><a href="admin_food_detail.php?f_id=<?php echo $f_id ?>" class="text-decoration-none text-danger">Clear Search
