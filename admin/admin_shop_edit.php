...
<head>
    ...
    if (isset($_POST["upd_confirm"])) {
        ...
        if (isset($_POST["s_preorderstatus"])) {
            $s_preorderstatus = 1;
        } else {
            $s_preorderstatus = 0;
        }
    ...
    <title>Update shop information </title>
</head>
    ...
    <div class="container form-signin mt-auto w-50">
        ...
        <form method="POST" action="admin_shop_edit.php" class="form-floating" enctype="multipart/form-data">
            ...
            <div class="form-check form-switch">
                <input class="form-check-input" type="checkbox" id="shopstatus" name="s_status" <?php if ($row["s_status"]) {
                                                                                                    echo "checked";
                                                                                                } ?>>
                <label class="form-check-label" for="shopstatus">Opening for today</label>
            </div>
            <div class="form-check form-switch mb-2">
                <input class="form-check-input" type="checkbox" id="shoppreorderstatus" name="s_preorderstatus" <?php if ($row["s_preorderstatus"]) {
                                                                                                                    echo "checked";
                                                                                                                } ?>>
                <label class="form-check-label" for="shoppreorderstatus">Accepting Pre-Order</label>
            </div>
            <div class="form-floating mb-2">
                <input type="text" class="form-control" id="shopusername" placeholder="Username" name="s_username" value="<?php echo $row["s_username"]; ?>" required>
