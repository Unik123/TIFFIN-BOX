...
<body class="d-flex flex-column h-100">
    ...
    <div class="container p-2 pb-0" id="admin-dashboard">
        <div class="mt-4 border-bottom">
            ...
            <form class="form-floating mb-3" method="GET" action="admin_customer_list.php">
                <div class="row g-2">
                    <div class="col">
                        <input type="text" class="form-control" id="username" name="un" placeholder="Username" <?php if (isset($_GET["search"])) { ?>value="<?php echo $_GET["un"]; ?>" <?php } ?>>
                    </div>
                    <div class="col">
                        <input type="text" class="form-control" id="firstname" name="fn" placeholder="First name" <?php if (isset($_GET["search"])) { ?>value="<?php echo $_GET["fn"]; ?>" <?php } ?>>
                    </div>
                    <div class="col">
                        <input type="text" class="form-control" id="lastname" name="ln" placeholder="Last name" <?php if (isset($_GET["search"])) { ?>value="<?php echo $_GET["ln"]; ?>" <?php } ?>>
                    </div>
                    <!-- <div class="col">
                    ...
                    <div class="col-auto">
                        ...
                        <button type="reset" class="btn btn-danger" onclick="javascript: window.location='admin_customer_list.php'">Clear</button>
    ...
    <div class="container pt-2" id="cust-table">
        ...
        if (!isset($_GET["search"])) {
            ...
            // $search_ut=$_GET["ut"];
            $search_query = "SELECT c_id,c_username,c_firstname,c_lastname,c_type,c_email FROM customer
                WHERE c_username LIKE '%{$search_un}%' AND c_firstname LIKE '%{$search_fn}%' AND c_lastname LIKE '%{$search_ln}%'; ";
        ...
        <?php } else { ?>
            <div class="table-responsive">
                <table class="table rounded-5 table-light table-striped table-hover align-middle caption-top mb-5">
                    <caption><?php echo $search_numrow; ?> customer(s) <?php if (isset($_GET["search"])) { ?><br /><a href="admin_customer_list.php" class="text-decoration-none text-danger">Clear Search
                    ...
                    <tbody>
                        ...
                        while ($row = $search_result->fetch_array()) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="admin_customer_detail.php?c_id=<?php echo $row["c_id"] ?>" class="btn btn-sm btn-primary">View</a>
                                    <a href="admin_customer_edit.php?c_id=<?php echo $row["c_id"] ?>" class="btn btn-sm btn-outline-success">Edit</a>
                                    <a href="admin_customer_delete.php?c_id=<?php echo $row["c_id"] ?>" class="btn btn-sm btn-outline-danger">Delete</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
    ...
    <footer class="footer d-flex flex-wrap justify-content-between align-items-center px-5 py-3 mt-auto bg-secondary text-light">
        <span class="smaller-font">&copy; 2022 Tiffin Box<br /><span class="xsmall-font">All Rights Reserved.</span></span>
