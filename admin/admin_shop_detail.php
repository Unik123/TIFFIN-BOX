        ...
        <div class="container row row-cols-6 row-cols-md-12 g-5 pt-4 mb-4" id="shop-header">
            ...
            <div class="col-6 col-md-8">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="">Telephone number: <?php echo "(01) " . $shop_row["s_phoneno"]; ?></li>
                </ul>
            ...
            <form class="form-floating mb-1 " method="GET" action="admin_shop_detail.php">
                <div class="row g-2">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" id="foodname" name="fdn" placeholder="Food name" <?php if (isset($_GET["search"])) { ?>value="<?php echo $_GET["fdn"]; ?>" <?php } ?>>
                    </div>
                    <div class="col-auto">
                        <button type="submit" name="search" value="1" class="btn btn-success">Search</button>
                        <button type="reset" class="btn btn-danger" onclick="javascript: window.location='admin_shop_detail.php?s_id=<?php echo $s_id ?>'">Clear</button>
            ...
            <div class="container align-items-stretch">
                ...
                <div class="table-responsive">
                    <table class="table rounded-5 table-light table-striped table-hover align-middle caption-top mb-3">
                        <caption><?php echo $numrow; ?> item(s) <?php if (isset($_GET["search"])) { ?><br /><a href="admin_shop_detail.php?s_id=<?php echo $s_id ?>" class="text-decoration-none text-danger">Clear Search
                        ...
                        <tbody>
                            ...
                            while ($row = $result->fetch_array()) { ?>
                                <tr>
                                    ...
                                    <td><?php printf("%.2f ", $row["f_price"]); ?></td>
                                    <td class="text-wrap">
                                    ...
                                    <td>
                                        <a href="admin_food_detail.php?f_id=<?php echo $row["f_id"] ?>" class="btn btn-sm btn-primary">View</a>
                                        <a href="admin_food_edit.php?f_id=<?php echo $row["f_id"] ?>" class="btn btn-sm btn-outline-success">Edit</a>
                                        <a href="admin_food_delete.php?f_id=<?php echo $row["f_id"] ?>" class="btn btn-sm btn-outline-danger">Delete</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
