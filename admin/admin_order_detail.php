                ...
                <div class="col mb-2 mb-md-0">
                    <ul class="list-unstyled fw-light">
                        ...
                        <li class="list-item">Order of
                            <a class="text-decoration-none link-primary" href="admin_customer_detail.php?c_id=<?php echo $orh_arr['c_id'] ?>">
                                <?php
                ...
                <div class="row row-cols-1">
                    ...
                    <div class="col my-3">
                        <ul class="list-inline justify-content-between">
                            ...
                            <li class="list-item fw-light small">Cash On Delivery
                                <!-- <?php
