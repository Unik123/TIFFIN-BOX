    ...
    <div class="container form-signin mt-auto w-50">
        ...
        <form method="POST" action="admin_customer_edit.php" class="form-floating">
            ...
            <div class="form-floating mb-2">
                <input type="text" class="form-control" id="firstname" placeholder="First Name" name="firstname" value="<?php echo $row["c_firstname"]; ?>" required>
            ...
            <div class="form-floating">
                <select class="form-select mb-2" id="gender" name="gender">
                    ...
                    <option value="N" <?php if ($row["c_gender"] == "N") {
                                            echo "selected";
                                        } ?>>Non-binary</option>
                </select>
            ...
            <div class="form-floating">
                <select class="form-select mb-2" id="type" name="type">
                    ...
                    <option value="INS" <?php if ($row["c_type"] == "INS") {
                                            echo "selected";
                                        } ?>>Professor</option>
                    <option value="TAS" <?php if ($row["c_type"] == "TAS") {
                                            echo "selected";
                                        } ?>>Teaching Assistant</option>
                    <option value="STF" <?php if ($row["c_type"] == "STF") {
                                            echo "selected";
