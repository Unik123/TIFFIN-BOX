...
<head>
    ...
    <title>Database Error | Tiffin Box</title>
</head>
...
<body class="d-flex flex-column h-100">
    <header class="navbar navbar-expand-md navbar-light fixed-top bg-light shadow-sm mb-auto">
        <div class="container-fluid mx-4">
            <a href="index.php">
                <img src="https://cdn.dribbble.com/users/1172898/screenshots/5874290/tiffin_box.jpg" width="75" class="me-2" alt="EATERIO Logo">
            </a>
    ...
    <div class="container form-signin text-center restricted mt-auto">
        ...
        <p class="mb-3 fw-normal text-bold text-wrap">Cannot connect to Tiffin Box database right now.</p>
