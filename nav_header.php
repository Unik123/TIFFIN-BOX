...
<header class="navbar navbar-expand-md navbar-light fixed-top bg-light shadow-sm mb-auto">
    <div class="container-fluid mx-3">
        <a href="index.php">
            <img src="https://cdn.dribbble.com/users/1172898/screenshots/5874290/tiffin_box.jpg" width="100" class="me-3" alt="Tiffin Box">
        ...
        <div class="navbar-collapse collapse" id="navbarCollapse">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
                ...
                <li class="nav-item">
                    <a href="about.php" class="nav-link px-2 text-dark font-weight-bold">About Us</a>
                </li>

                <li class="nav-item">
                    <a href="contact.php" class="nav-link px-2 text-dark font-weight-bold">Contact</a>
                </li>
