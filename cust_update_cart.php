        ...
        <div class="row row-cols-1 row-cols-md-2 mb-5">
            <div class="col mb-3 mb-md-0">
                <img <?php
                        ...
                        ?> class="img-fluid rounded-25 float-start" alt="<?php echo $food_row["f_name"] ?>">
            </div>
                ...
                <div class="form-amount">
                    <form class="mt-3" method="POST" action="cust_update_cart.php">
                        <div class="input-group mb-3">
                            ...
                            <input type="number" class="form-control text-center border-secondary" id="amount" name="amount" value="<?php echo $ci_arr["ct_amount"] ?>" min="1" max="99">
