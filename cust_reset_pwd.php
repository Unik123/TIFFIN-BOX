...
<head>
    ...
    <title>Reset Password | Tiffin Box</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin mt-auto">
        ...
        <form method="POST" action="cust_reset_pwd.php" class="form-floating">
            ...
            <div class="form-floating mb-2">
                <input type="password" class="form-control" id="rst_pwd" minlength="8" maxlength="45" placeholder="Confirm New Password" name="new_cfpwd" required>
